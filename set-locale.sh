...
if [[ ! -z "$2" && "$2" != "--quiet" ]]; then
    HASHED_EMAIL=$2
    SESSION_COOKIE=${ROOT_PATH}/sessions/${HASHED_EMAIL}-session-cookies.jar
...
RETURN_TO="http://offline-studio.code.org/home"
